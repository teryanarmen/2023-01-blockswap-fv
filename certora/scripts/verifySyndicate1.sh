...
certoraRun  certora/harnesses/SyndicateHarness.sol \
    ...
    --optimize 1 \
    --loop_iter 3 \
    --rules canNotDegisterUnregisteredKnot_ totalEthReceivedMonotonicallyIncreases noOneCanAlterTheMoneyYouHave noOneCanAlterTheMoneyYouHave_2 stakeThenUnstake \
    --rule_sanity \
