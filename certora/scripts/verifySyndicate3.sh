certoraRun  certora/harnesses/SyndicateHarness.sol \
    ...
    --optimize 1 \
    --loop_iter 3 \
    --rules cannotWriteStateVariablesWithoutCallToUpdate addressZeroHasNoBalance both_sum_are_sound sETHSolvency totalStakeAmount lastAccumulatedETHPerFreeFloatingShare_is_0_unless_deregistered \
    --rule_sanity \
