certoraRun  certora/harnesses/SyndicateHarness.sol \
    ...
    --optimize 1 \
    --loop_iter 3 \
    --rules lastAccumulatedETHPerFreeFloatingShareCannotChangeOnceDeregistered sETHUsETHUserClaimForKnot_sound completeInvariant imprecisionIsBounded impressisionIsBounded \
    --rule_sanity \
